...
## Project Structure
    ...
    ├── testapiautosetting_123656  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123656`
...
2. Clone this repo and `cd testapiautosetting_123656`
